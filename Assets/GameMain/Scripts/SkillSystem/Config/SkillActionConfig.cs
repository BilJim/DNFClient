...
public class SkillActionConfig
{
    ...
    [LabelText("移动所需时间(毫米奥)")] public int durationMs;
    ...
    public void OnMoveActionFinishOperationChange(MoveActionFinishOperation value)
    {
        mIsShowFinishParam = value != MoveActionFinishOperation.None;
    }
}
