...
namespace FixIntPhysics
{
    ...
    public abstract class ColliderBehaviour 
    {
        ...
        public virtual void SetBoxData(float radius, Vector3 center, bool isFollowTarget = false) { }
        public virtual void SetBoxData(FixInt radius, FixIntVector3 center, bool isFollowTarget = false) { }
        public virtual void SetBoxData(Vector3 center, Vector3 size, bool isFollowTarget = false) { }
        public virtual void SetBoxData(FixIntVector3 center, FixIntVector3 size, bool isFollowTarget = false) { }
